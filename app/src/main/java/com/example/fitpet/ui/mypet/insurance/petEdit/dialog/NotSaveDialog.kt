...
import com.example.fitpet.databinding.DialogNotSaveBinding
...
class NotSaveDialog @Inject constructor(
    @ActivityContext context: Context
): AlertDialog(context) {
    private val binding: DialogNotSaveBinding by lazy {
        DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.dialog_not_save, null, false)
    }
