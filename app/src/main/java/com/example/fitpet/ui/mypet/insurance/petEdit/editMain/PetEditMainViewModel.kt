...
@HiltViewModel
class PetEditMainViewModel @Inject constructor(private val petsRepository: PetsRepository): BaseViewModel<PetEditMainPageState>() {
    ...
    override val uiState = PetEditMainPageState(
        ...
        viewModelScope.launch {
            petsRepository.getPetAllMainInfo().collect { result ->
                result.onSuccess { response ->
                    ...
                    emitEventFlow(PetEditMainEvent.FetchPetData)
                }.onFailure {
                    // Handle error
                    Timber.e(it)
                }
