...
import com.example.fitpet.databinding.DialogEraseBinding
...
class DeleteDialog @Inject constructor(
    ...
    private val binding: DialogEraseBinding by lazy {
        DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.dialog_erase, null, false)
    }
