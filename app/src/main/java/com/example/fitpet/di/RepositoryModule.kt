...
import com.example.fitpet.data.repositoryImpl.AlarmRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Singleton
    @Binds
    abstract fun providesAlarmRepository(repositoryImpl: AlarmRepositoryImpl): AlarmRepository
}